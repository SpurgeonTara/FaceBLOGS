!(function (e, u) {
  ...
  function q(e, u, t) {
    ...
    return "!" !== e[0].charAt(0)
      ...
      : { type: "image", raw: t, href: n, title: r, text: R(u) };
  }
  var O = (function () {
      function e(e) {
        this.options = e || S;
      ...
      return (
        ...
        (u.autolink = function (e, u) {
          ...
          if (e) {
            var t,
              u =
                "@" === e[2]
                  ? "mailto:" + (t = R(this.options.mangle ? u(e[1]) : e[1]))
                  : (t = R(e[1]));
            return {
              type: "link",
              raw: e[0],
        ...
        (u.url = function (e, u) {
          ...
          if ((t = this.rules.inline.url.exec(e))) {
            if ("@" === t[2])
              r = "mailto:" + (n = R(this.options.mangle ? u(t[0]) : t[0]));
            else {
              for (
                ;
                (i = t[0]),
            ...
            t = u
              ? this.options.sanitize
                ? this.options.sanitizer
                  ...
                  : R(e[0])
                : e[0]
              : R(this.options.smartypants ? t(e[0]) : e[0]);
  ...
  (x.def = _(x.def)
    ...
    (x.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (x.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
    (x.item = _(x.item, "gm").replace(/bull/g, x.bullet).getRegex()),
    (x.listItemStart = _(/^( *)(bull) */)
    ...
    (x.pedantic = w({}, x.normal, {
      ...
      heading: /^(#{1,6})(.*)(?:\n+|$)/,
      fences: y,
      paragraph: _(x.normal._paragraph)
        .replace("hr", x.hr)
        .replace("heading", " *#{1,6} *[^\n]")
  ...
  (y.punctuation = _(y.punctuation)
    .replace(/punctuation/g, y._punctuation)
    .getRegex()),
    (y.blockSkip = /\[[^\]]*?\]\([^\)]*?\)|`[^`]*?`|<[^>]*?>/g),
    (y.escapedEmSt = /\\\*|\\_/g),
    (y._comment = _(x._comment).replace("(?:--\x3e|$)", "--\x3e").getRegex()),
    (y.emStrong.lDelim = _(y.emStrong.lDelim)
      .replace(/punct/g, y._punctuation)
      .getRegex()),
    (y.emStrong.rDelimAst = _(y.emStrong.rDelimAst, "g")
      .replace(/punct/g, y._punctuation)
      .getRegex()),
    (y.emStrong.rDelimUnd = _(y.emStrong.rDelimUnd, "g")
      .replace(/punct/g, y._punctuation)
      .getRegex()),
    (y._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (y.link = _(y.link)
      ...
      .getRegex()),
    (y.reflink = _(y.reflink).replace("label", y._label).getRegex()),
    (y.reflinkSearch = _(y.reflinkSearch, "g")
  ...
  function N(e) {
    for (var u, t = "", n = e.length, r = 0; r < n; r++)
      (u = e.charCodeAt(r)),
        0.5 < Math.random() && (u = "x" + u.toString(16)),
        (t += "&#" + u + ";");
    return t;
  }
  var X = (function () {
